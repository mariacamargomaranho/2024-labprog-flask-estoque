import uuid
from sqlalchemy import Uuid, DECIMAL, Integer, String, Boolean, Text, ForeignKey
...
class Produto(db.Model, BasicRepositoryMixin,TimeStampMixin):
    ...
    foto_base64 = mapped_column(Text, nullable=None, index=True)
    foto_mine = mapped_column(String(64),nullable=True, index=None )
